...
public class Spiel implements Serializable {
	...
	private String invalid = "Ung�ltig";
		...
		try {
			...
			if (saveGesundheit > Konstanten.VOLLH) {
				JOptionPane.showMessageDialog(null,
						"In der Datei gibt es eine ung�ltige Healthanzahl",
			...
			if (saveMana > Konstanten.VOLLM) {
				JOptionPane.showMessageDialog(null,
						"In der Datei gibt es eine ung�ltige Manaanzahl",
						invalid, JOptionPane.ERROR_MESSAGE);
				System.exit(0);
			}
			...
			if (saveRuestung > Konstanten.VOLLR) {
				JOptionPane.showMessageDialog(null,
						"In der Datei gibt es eine ung�ltige Ruestungsanzahl",
						invalid, JOptionPane.ERROR_MESSAGE);
				System.exit(0);
			}
			...
			if (saveLeben > Konstanten.DREILEBEN) {
				JOptionPane.showMessageDialog(null,
						"In der Datei gibt es eine ung�ltige Lebenanzahl",
						invalid, JOptionPane.ERROR_MESSAGE);
				System.exit(0);
			}
	...
	public void levelWeiter(Spieler spielfigur) {
		...
		/* Naechstes Spielfeld */
		aktSpielfeld += 1;
		/* n�chstes Spielfeld aus ArrayList levels */
