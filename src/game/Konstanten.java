...
/** eigene Klasse f�r Konstanten, die hier nur einmal deklariert werden m�ssen */
public final class Konstanten {
	...
	/** int-Varbiablen werden f�r txt-Zeichen deklariert */
	...
	public static final int LASER = (int) '�';
	public static final int GEGNERTOT = (int) '�';
	public static final int SCHWERT = (int) '�';
	public static final int SHOPMANA = (int) 'A';
	public static final int SHOPHEALTH = (int) 'Q';
	public static final int SHOPRUESTUNG = (int) '�';
	...
	/** die Gr��e eines Feldes wird deklariert */
	...
	/** die R�stungs Staffelungen werden deklariert */
	...
	/** die Groessen f�r das Steuerungsfenster */
	...
	/** Positionen f�r Button Weiter NPCfenster */
	...
	/** Positionen f�r Button Skip NPCfenster */
	...
	/** Positionen f�r Buttons auf MenuFrame */
	...
	/** Loop Angabe f�r Musik */
	public static final int LOOP = 999;

	/** Angabe f�r Panelposition */
	public static final int PANEL = 10;

	/** Raumangaben f�r Bossauswahl */
	...
	/**
	 * privater Konstruktor, der verhindert, dass von au�en ein Exemplar dieser
